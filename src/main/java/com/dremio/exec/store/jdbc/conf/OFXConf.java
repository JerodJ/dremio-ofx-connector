...
@SourceType(value = "OFXARP", label = "OFX",uiConfig = "ofx-layout.json")
public class OFXConf extends AbstractArpConf<OFXConf> {
  private static final String ARP_FILENAME = "arp/implementation/ofx-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.ofx.OFXDriver";
